...
if __name__ == '__main__':
        ...
        jobname  = {
                    ...
                    4:'mitStuff2nd', 
                    7:'noDefectNowall', #'biCrystalMultipleTemp2nd/temp0', 
                   }[7]
        ...
        def SetVariables():
            Variable = {
                    ...
                    12:' -var buff 0.0 -var buffy 0.0 -var T 300 -var swap_every 10 -var swap_atoms 20 -var rn %s -var dump_every 10 -var ParseData 1 -var DataFile equilibrated.dat -var DumpFile traj.dump'%np.random.randint(1001,100000),
